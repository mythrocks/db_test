...
CUDA_FLAGS =  -gencode arch=compute_60,code=sm_60 -gencode arch=compute_70,code=sm_70 -gencode arch=compute_75,code=sm_75 -gencode arch=compute_75,code=compute_75 --expt-extended-lambda --expt-relaxed-constexpr -Werror cross-execution-space-call -Xcompiler -Wall,-Werror -O3 -DNDEBUG -Xcompiler=-fPIE   -DJITIFY_USE_CACHE -DCUDF_VERSION=0.11.0 -std=c++14
