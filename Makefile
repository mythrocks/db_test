...
# at startup. 
all:	
	cd ~/projects/cudf/cpp/build && $(MAKE) -f ~/projects/cudf/cpp/build/Makefile nvstrings
	cd ~/projects/cudf/cpp/build && $(MAKE) -f ~/projects/cudf/cpp/build/Makefile cudf
	cd ~/projects/cudf/cpp/build && $(MAKE) -f ~/projects/cudf/cpp/build/Makefile cudftestutil
