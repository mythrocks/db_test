...
db_test:	cudf db_test.o db_test_utils.o db_test_archive.o
	echo $(CUDF_DIR)
	/usr/bin/c++ -Wl,--disable-new-dtags db_test.o db_test_utils.o db_test_archive.o -o DB_TEST  -L/usr/local/cuda/targets/x86_64-linux/lib/stubs  -L/usr/local/cuda/targets/x86_64-linux/lib  -L$(CUDF_DIR)/build/lib  -L$(CUDF_DIR)/build  -L$(CUDF_DIR)/build/arrow/build/flatbuffers_ep-prefix/src/flatbuffers_ep-install/lib  -L$(CUDF_DIR)/build/googletest/install/lib -Wl,-rpath,/usr/local/cuda/targets/x86_64-linux/lib/stubs:$(CUDF_DIR)/build:/home/dbaranec/miniconda3/envs/cudf_dev/lib:/usr/local/cuda/targets/x86_64-linux/lib:$(CUDF_DIR)/build/lib:$(CUDF_DIR)/build/arrow/build/flatbuffers_ep-prefix/src/flatbuffers_ep-install/lib:$(CUDF_DIR)/build/googletest/install/lib -lpthread $(CUDF_DIR)/build/tests/libcudftestutil.a $(CUDF_DIR)/build/libcudf.so /home/dbaranec/miniconda3/envs/cudf_dev/lib/libnvToolsExt.so -lNVCategory -lnvToolsExt -Wl,--whole-archive /home/dbaranec/miniconda3/envs/cudf_dev/lib/libarrow_cuda.so -Wl,--no-whole-archive /home/dbaranec/miniconda3/envs/cudf_dev/lib/libarrow.so $(CUDF_DIR)/build/googletest/install/lib/libgtest.a -lnvrtc -lcudart -lcuda /home/dbaranec/miniconda3/envs/cudf_dev/lib/libz.so /home/dbaranec/miniconda3/envs/cudf_dev/lib/libboost_filesystem.so -lcudadevrt -lcudart_static -lrt -lpthread -ldl
